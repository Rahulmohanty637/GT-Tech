...
const HeroData = [
  ...
  },
  {
    ...
    img: Image2,
    subtitle: "Gram Tarang",
    title: "Unlock Innovation, Efficiency, and Progress",
    title2: "Innovation",
  },
  {
    id: 1,
    img: Image3,
    subtitle: "Gram Tarang",
    title: "with GT-Tech as Your Strategic Partner",
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2">
                  ...
                  <div className="flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10 ">
                    ...
                    <h1
                      ...
                      data-aos-duration="500"
                      data-aos-once="true"
                      className="text-5xl uppercase text-btn dark:text-white/5 sm:text-[50px] md:text-[70px] xl:text-[100px] font-bold"
                    >
                      {data.title2}
                    </h1>
                    <div
                  ...
                  <div className="order-1 sm:order-2">
                    ...
                    >
                      <img
                        src={data.img}
                        alt=""
                        className="w-[300px] sm:w-[450px] h-[300px] sm:h-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] relative"
                      />
                    </div>
                  </div>
                </div>
